...
subtitle: IRIS-CEM 
abstract: IRIS-CEM integrates in-house and state-of-the-art computational tools and provides two analysis strategies, including LTMG (left-truncated mixture Gaussian model)-embedded scRNA-Seq analy-sis and co-expression gene analysis.
author: Yuzhou Chang
date: "12 Aug, 2020"
output:
...
2. IRIS-CEM also accept output files from 10X CellRanger, includinhg a folder which contains three individual files and h5 file. 
